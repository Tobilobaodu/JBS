...
3. **Start the LLM provider/model decision now**, in parallel with Sprint 3 kickoff — see Open Decisions above; this has non-engineering lead time (DPA/procurement) that can otherwise stall Sprint 3 later.
